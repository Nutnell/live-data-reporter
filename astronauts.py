...
def fetch_astronauts():
    ...
    try:
        ...
        log_action("Astronauts Module", "Fetch Astronauts API Call", "Success")
        ...
        try:
            ...
            log_action("Astronauts Module", "Save Astronauts Data", "Success")
        except IOError as e:
            print(f"Error saving astronauts data to file: {e}")
            log_action("Astronauts Module", "Save Astronauts Data", f"Failure: {e}")
        ...
        log_action("Astronauts Module", "Fetch Astronauts API Call", f"Failure: {e}")
    except json.JSONDecodeError as e:
        print(f"Error decoding JSON response from astronauts API: {e}")
        log_action("Astronauts Module", "Decode Astronauts JSON", f"Failure: {e}")
    except Exception as e:
        print(f"An unexpected error occurred: {e}")
        log_action("Astronauts Module", "Unexpected Error", f"Failure: {e}")
